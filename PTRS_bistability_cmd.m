...
%% --------------- Generate Fig. 5 and S3B - Saddle-node bifurcation from XPP-AUT results ------------------- %%

[num, txt] = xlsread('Bistability_bifurcation_k0.xlsx'); % Bifurcation_k0.xlsx contains bufucation results obtained from XPP-AUT
...
%% --------------- Generate Fig. 6A and S3A - H2O2 null curves ---------------------------------------------- %%
init = default_init;
param = default_param;
...
for i = 1 : 1 : 3
        ...
        for j= 2:1:length(H2O2_vector)   % skipping the first concentration where H2O2 could be 0
            if j==length(H2O2_vector)    % stop when reaching the last concentration because no next concentration is avaiable to calculate the delta
                break
            end
...
%% --------------- Generate Fig. 6A and S3A - PRXSO2H null curve -------------------------------------------- %%
init = default_init;
param = default_param;
param.H2O2_switch = 0;
PRXSO2H_vector = [];
...
% zlabel('H2O2 (uM)')
% colorbar
% yline(default_param.k1,'--r')

%

%% --------------- Generate Fig. 7A right panel ------------------------------------------------------------- %%
init = default_init;
param = default_param;
param.H2O2_switch = 0;
increment = 1.1;
...
% % 3D surface plot
% figure(7023) 
% mesh(k0(1:20:end), k2a(1:20:end), H2O2_switch_on(1:20:end,1:20:end));
% hold on
% mesh(k0(1:20:end), k2a(1:20:end), H2O2_switch_off(1:20:end,1:20:end));
% xlabel('k0')
% ylabel('k2a')
% zlabel('H2O2 (uM)')
% colorbar
% yline(default_param.k2a,'--r')

%

%% --------------- Generate Fig. 7B right panel ------------------------------------------------------------- %%
init = default_init;
param = default_param;
param.H2O2_switch = 0;
...
% % 3D surface plot
% figure(7033) 
% mesh(k0(1:20:end), k2b(1:20:end), H2O2_switch_on(1:20:end,1:20:end));
% hold on
% mesh(k0(1:20:end), k2b(1:20:end), H2O2_switch_off(1:20:end,1:20:end));
% xlabel('k0')
% ylabel('k2b')                                       
% zlabel('H2O2 (uM)')
% colorbar
...
% % 3D surface plot
% figure(40013) 
% mesh(k0(1:20:end), k2c(1:20:end), H2O2_switch_on(1:20:end,1:20:end));
% hold on
% mesh(k0(1:20:end), k2c(1:20:end), H2O2_switch_off(1:20:end,1:20:end));
% xlabel('k0')
% ylabel('k2c')                                       
% zlabel('H2O2 (uM)')
% colorbar
...
% save Two_par_k0Km2c_H2O2_switch_on.mat H2O2_switch_on
% save Two_par_k0Km2c_H2O2_switch_off.mat H2O2_switch_off
% save Two_par_k0Km2c_Km2c.mat Km2c
% save Two_par_k0Km2c_k0.mat k0
...
% % 3D surface plot
% figure(40023) 
% mesh(k0(1:20:end), Km2c(1:20:end), H2O2_switch_on(1:20:end,1:20:end));
% hold on
% mesh(k0(1:20:end), Km2c(1:20:end), H2O2_switch_off(1:20:end,1:20:end));
% xlabel('k0')
% ylabel('Km2c')                                       
% zlabel('H2O2 (uM)')
% colorbar
...
% % 3D surface plot
% figure(40033)
% mesh(k0(1:20:end), TRXtot(1:20:end), H2O2_switch_on(1:20:end,1:20:end));
% hold on
% mesh(k0(1:20:end), TRXtot(1:20:end), H2O2_switch_off(1:20:end,1:20:end));
% xlabel('k0')
% ylabel('TRXtot')
% zlabel('H2O2 (uM)')
% colorbar
...
% % 3D surface plot
% figure(40043) 
% mesh(k0(1:20:end), TRtot(1:20:end), H2O2_switch_on(1:20:end,1:20:end));
% hold on
% mesh(k0(1:20:end), TRtot(1:20:end), H2O2_switch_off(1:20:end,1:20:end));
% xlabel('k0')
% ylabel('TRtot')
% zlabel('H2O2 (uM)')
% colorbar
